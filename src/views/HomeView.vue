...
<template>
  ...
  <div class="max-w-7xl mx-auto flex flex-col justify-center min-h-screen">

    <div>
      <MintCard :show-hero="true" hero-title="POFER TO COMMUNITY" hero-subtitle="WIF SAMO" hero-message="SAMOWIF is a community-driven memecoin that puts the power in the hands of the people. Our mission is to
                build a strong and healthy community by providing tools and services that will benefit everyone. With
                SAMOWIF power, we can conquer the world!" />
    </div>
  ...
  <div id="leaderboard-section" class="mt-16 border-b-2 border-teal-500">
    <div class="max-w-7xl mx-auto py-16 space-y-8">
      ...
      <ZealyLeaderboard class="p-4 xl:p-0" />
    </div>
...
import BackgroundAnimatedImage from '@/components/BackgroundAnimatedImage.vue';
import {useWallet} from "solana-wallets-vue";
import ZealyLeaderboard from "../components/ZealyLeaderboard.vue";
